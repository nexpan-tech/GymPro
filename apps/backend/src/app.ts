...
import personalWorkoutRoutes from "./modules/personal-workout/personal-workout.routes";
import personalDietRoutes from "./modules/personal-diet/personal-diet.routes";
...
import featureFlagRoutes from "./modules/feature-flag/feature-flag.routes";
...
app.use("/api/v1/personal-workouts", personalWorkoutRoutes);
app.use("/api/v1/personal-diets", personalDietRoutes);
