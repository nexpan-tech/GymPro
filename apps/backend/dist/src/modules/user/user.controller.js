...
exports.createUser = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return (0, response_1.successResponse)(res, "User created successfully", user, 201);
});
exports.getUsers = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return (0, response_1.successResponse)(res, "Users fetched successfully", users, 200);
});
exports.getUserById = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return (0, response_1.successResponse)(res, "User fetched successfully", user, 200);
});
exports.updateUser = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return (0, response_1.successResponse)(res, "User updated successfully", updated, 200);
});
exports.deleteUser = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    return (0, response_1.successResponse)(res, "User deleted successfully", null, 200);
});
